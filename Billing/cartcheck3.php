...
<form id="four" action="http://localhost/chariot.com/Billing/complete.php" method="POST"></form>
...
<input form="four" type="hidden" name="gst" value=<?php echo $gst; ?> />
<input form="four" type="hidden" name="cst" value=<?php echo $cst; ?> />
<input form="four" type="hidden" name="net1" value=<?php echo $net1; ?> />
<input form="four" type="hidden" name="points" value=<?php echo $points; ?> />
...
<input form="four" type="hidden" name="proper18" value="yes" />
